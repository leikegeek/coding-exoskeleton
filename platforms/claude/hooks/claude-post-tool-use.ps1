...
Write-HarnessEvent -EventType "edit" -HookName "claudePostToolUse" -Detail $changedPath -Outcome "allow"
Allow-Hook -Message "claude post-tool audit logged"

} catch {
    Allow-Hook -Message "claude post-tool fallback allow"
}
