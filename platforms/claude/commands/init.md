---
description: 初始化 Exoskeleton 项目画像与治理上下文
argument-hint: [项目说明或路径]
...
> - 个人作者配置：`~/.exoskeleton/user-config.json`（如已配置；legacy `~/.cursor/coding-exoskeleton/user-config.json` 仅作为兼容读取路径）
>
